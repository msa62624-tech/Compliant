        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-sm text-gray-500 mt-1">Broker verified</p>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a
                href="/assignments"
                className="block p-4 border border-gray-200 rounded-lg hover:border-purple-500 hover:shadow transition"
              >
                <h4 className="font-semibold text-gray-900">My Assignments</h4>
                <p className="text-sm text-gray-600 mt-1">
                  View your current project assignments
                </p>
              </a>
              <a
                href="/insurance"
              ...
              >
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Manage your insurance documentation
                </p>
              </a>
              <a
                href="/timesheets"
              ...
              >
                ...
                <p className="text-sm text-gray-600 mt-1">Submit and track your work hours</p>
              </a>
              <a
                href="/profile"
                className="block p-4 border border-gray-200 rounded-lg hover:border-purple-500 hover:shadow transition"
